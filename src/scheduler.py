...
def send_aggregated_notification(notifier: TelegramNotifier, new_listings: list, total_scraped: int):
    """Send a single notification summarising the scan results."""
    ...
    if not new_listings:
        message = (
            ...
            f"⏰ {now_str}\n"
            f"━━━━━━━━━━━━━━━━━━━━━\n"
            f"Scanned {total_scraped} listings — no new ones found."
        )
        notifier.send_message(message)
        logger.info("Sent 'no new listings' summary notification")
        return
