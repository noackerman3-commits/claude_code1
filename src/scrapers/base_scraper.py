...
class BaseScraper:
    ...
    def initialize_browser(self):
        ...
        try:
            ...
            # Allow pointing at a pre-installed browser binary when the
            # environment's bundled Chromium revision doesn't match the
            # version Playwright expects (avoids a network download).
